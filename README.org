...
to correctly do it. I knew the quick sort would be fast but I was actually 
suprised at how much faster the merge sort was in my testing. The merge sort
ended up being the second fastest. It was faster than the quick sort I had.
But my quick sort was faster than quick sort from class. 
Overall, the default quick sort was the fastest by far. 
